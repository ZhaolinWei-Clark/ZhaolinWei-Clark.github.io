...
/* ── BODY LAYOUT ── */
.body-grid{display:grid;grid-template-columns:1fr 200px;gap:0;margin-top:0;align-items:start}

/* ── SIDEBAR ── */
.sidebar{position:sticky;top:0;height:100vh;overflow-y:auto;padding:40px 0 40px 28px;border-left:1px solid var(--border-lt);display:flex;flex-direction:column;gap:0}
...
.card-grid.g1{grid-template-columns:minmax(0,560px)}
.card-grid.g2{grid-template-columns:repeat(2,1fr)}
.card-grid.g3{grid-template-columns:repeat(3,1fr)}
.card-grid.g-auto{grid-template-columns:repeat(auto-fill,minmax(300px,1fr))}
...
.pmodal-hero-split img{width:100%;height:280px;object-fit:cover}
.pmodal-hero-triple{display:grid;grid-template-columns:1fr 1fr 1fr;max-height:300px;overflow:hidden;gap:2px}
.pmodal-hero-triple img{width:100%;height:220px;object-fit:cover}
...
/* ── RESPONSIVE ── */
@media(max-width:1100px){.shell{width:96%}.main{padding-right:36px}.card-grid.g3{grid-template-columns:1fr 1fr}}
@media(max-width:820px){
  .body-grid{grid-template-columns:1fr}
  .sidebar{position:static;height:auto;border-left:none;border-top:1px solid var(--border-lt);padding:22px 0 0;flex-direction:column}
  ...
  .card-grid.g2,.card-grid.g3{grid-template-columns:1fr}
...
@media(max-width:540px){
  ...
  .card-grid.g-auto,.card-grid.g2,.card-grid.g3{grid-template-columns:1fr}
}

/* Fade-in for category sections */
...
<section class="cat" id="cat-mech">
  ...
  <div class="cat-body" id="cat-mech-body">
    <div class="card-grid g2">
      ...
      <!-- Spindle -->
      <div class="card" data-tags="Motor,DFM,Manufacturing,Test" onclick="openModal('m-spindle')">
        <div class="card-img">
        ...
        <div class="card-body">
          ...
          <div class="card-tags"><span class="tag">Motor</span><span class="tag">DFM</span><span class="tag">Manufacturing</span><span class="tag">Test</span></div>
      ...
      <!-- Shaft Failure -->
      <div class="card" data-tags="Root Cause Analysis,Mechanical" onclick="openModal('m-shaft')">
        <div class="card-img">
        ...
        <div class="card-body">
          ...
          <p class="card-short">Root-cause investigation of industrial motor shaft fatigue crack — Fuwode Machinery. SEM fracture analysis, stress concentration evaluation, heat treatment audit.</p>
          <div class="card-tags"><span class="tag">Root Cause Analysis</span><span class="tag">Mechanical</span><span class="tag">Fatigue</span><span class="tag">FEA</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>
...
<section class="cat" id="cat-ctrl">
  ...
  <div class="cat-body" id="cat-ctrl-body">
    <div class="card-grid g2">
      ...
      <!-- BLDC -->
      <div class="card" data-tags="Motor,Control,MATLAB" onclick="openModal('m-bldc')">
        <div class="card-img">
          <div class="card-img-split">
        ...
        <div class="card-body">
          ...
          <div class="card-tags"><span class="tag">Motor</span><span class="tag">Control</span><span class="tag">MATLAB</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>
      ...
      <div class="card" data-tags="Python,Control,GUI" onclick="openModal('m-hvac')">
        ...
        <div class="card-body">
          ...
          <p class="card-short">Internship project at Sands China — GUI-based autonomous HVAC automation with real-time feedback loops and energy consumption optimization.</p>
...
<section class="cat" id="cat-res">
  ...
  <div class="cat-body" id="cat-res-body">
    <div class="card-grid g3">
      ...
      <!-- L-DED -->
      <div class="card" data-tags="MATLAB,Control,Manufacturing" onclick="openModal('m-lded')">
        <div class="card-img">
          <img src="/images/additivie set up.jpeg" alt="L-DED setup">
        </div>
        <div class="card-body">
          <p class="card-title">L-DED Closed-Loop Temperature Monitoring</p>
          <p class="card-short">Graduate thesis — real-time melt pool stabilization for laser-based directed energy deposition. CEL &amp; AMP Labs, UBC.</p>
          <div class="card-tags"><span class="tag">MATLAB</span><span class="tag">Control</span><span class="tag">Manufacturing</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>

      <!-- Self-powered sensor -->
      <div class="card" data-tags="CAD,Sensor,Test" onclick="openModal('m-sensor')">
        <div class="card-img">
          <img src="/images/fyp_um.png" alt="Flexible sensor">
        </div>
        <div class="card-body">
          <p class="card-title">Self-Powered Flexible Sensor System</p>
          <p class="card-short">Wearable self-powered electromechanical sensors for pulse and muscle signal detection — material synthesis through wearable device integration.</p>
          <div class="card-tags"><span class="tag">CAD</span><span class="tag">Sensor</span><span class="tag">Test</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>

      <!-- Chatter -->
      <div class="card" data-tags="Manufacturing,CNC,Control" onclick="openModal('m-chatter')">
        <div class="card-img">
          <div class="card-img-ph"><!-- INSERT IMAGE HERE -->
        ...
        <div class="card-body">
          ...
          <p class="card-short">FRF modeling, Stability Lobe Diagram, critical depth calculation, lead-lag feed drive control, and trapezoidal trajectory planning for CNC milling.</p>
          <div class="card-tags"><span class="tag">Manufacturing</span><span class="tag">CNC</span><span class="tag">Control</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>
...
<section class="cat" id="cat-robo">
  ...
  <div class="cat-body" id="cat-robo-body">
    <div class="card-grid g2">
      ...
      <!-- AlohaMini -->
      <div class="card" data-tags="CAD,3D Printing,Robotics" onclick="openModal('m-aloha')">
        <div class="card-img">
          <img src="/images/Image_robot_in_progress1.png" alt="AlohaMini robot">
        </div>
        <div class="card-body">
          <p class="card-title">Low-Cost Dual-Arm Mobile Robot — AlohaMini <span class="badge-wip">In Progress</span></p>
          <p class="card-short">Open-source teleoperated dual-arm manipulator — hardware integration, actuator control, imitation learning data pipeline.</p>
          <div class="card-tags"><span class="tag">CAD</span><span class="tag">3D Printing</span><span class="tag">Robotics</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>

      <!-- Surgical -->
      <div class="card" data-tags="Python,Control,Robotics" onclick="openModal('m-surgical')">
        <div class="card-img">
          <img src="/images/combined.png" alt="Surgical tracking">
        </div>
        <div class="card-body">
          <p class="card-title">3D Surgical Instrument &amp; Tissue Tracking</p>
          <p class="card-short">Real-time stereo vision tracking — Lucas-Kanade optical flow, Shi-Tomasi detection. &lt;0.8 px sub-pixel accuracy · 15% fewer tracking failures.</p>
          <div class="card-tags"><span class="tag">Python</span><span class="tag">OpenCV</span><span class="tag">Robotics</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>
...
<section class="cat" id="cat-emb">
  ...
  <div class="cat-body" id="cat-emb-body">
    <div class="card-grid g2">
      ...
      <!-- Heater -->
      <div class="card" data-tags="Embedded,Control,Test" onclick="openModal('m-heater')">
        <div class="card-img">
          <div class="card-img-split">
            <img src="/images/Poster Assembly Picture.PNG" alt="Assembly">
            <img src="/images/Poster Explorsion Veiw.PNG" alt="Exploded">
          </div>
        </div>
        <div class="card-body">
          <p class="card-title">Arduino Smart Cup Heater</p>
          <p class="card-short">Closed-loop temperature control, sensor calibration, user-selectable 10–80°C setpoint, real-time LCD feedback.</p>
          <div class="card-tags"><span class="tag">Embedded</span><span class="tag">Control</span><span class="tag">Test</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>

      <!-- EM Tool -->
      <div class="card" data-tags="Python,Control" onclick="openModal('m-em')">
        <div class="card-img">
          <div class="card-img-ph"><!-- INSERT IMAGE HERE -->
        ...
        <div class="card-body">
          ...
          <p class="card-short">Python automation of magnetic circuit analysis — eliminates manual iteration in preliminary DC permanent magnet motor design.</p>
          <div class="card-tags"><span class="tag">Python</span><span class="tag">Control</span><span class="tag">Motor</span></div>
          <button class="card-btn">View Details <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
        </div>
      </div>
...
<aside class="sidebar">
  ...
  <div class="sb-filters">
    ...
    <span class="ftag" data-f="GUI">GUI</span>
  </div>
</aside>
...
<!-- SPINDLE -->
<div class="pmodal-ov" id="m-spindle" onclick="closeOut(event,'m-spindle')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">Industrial CNC spindle series designed to client specifications — complete SolidWorks assemblies from concept through manufacturing-approved documentation.</p>
    <div class="pmodal-tags"><span class="tag">Motor</span><span class="tag">DFM</span><span class="tag">Manufacturing</span><span class="tag">Test</span><span class="tag">SolidWorks</span><span class="tag">GD&T</span></div>
    <div class="pmdiv"></div>
    <div class="pm-grid g3">
      ...
      <div class="pm-field"><p class="pm-label">Scope</p><div class="pm-val"><ul>
        <li>Bearing selection &amp; preload</li><li>Thermal management modeling</li>
        <li>Interference-fit validation</li><li>Structural stiffness verification</li>
      </ul></div></div>
      <div class="pm-field"><p class="pm-label">Deliverables</p><div class="pm-val"><ul>
        <li>A12B spindle assembly</li><li>A4 BT40 spindle assembly</li>
        <li>Tolerance stack-up report</li><li>GD&amp;T per ASME Y14.5</li>
    ...
    <div class="pm-callout">
      ...
      <ul>
        ...
        <li>Interference-fit validation with precision concentricity control (≤2 µm runout)</li>
...
<!-- S45C SHAFT -->
<div class="pmodal-ov" id="m-shaft" onclick="closeOut(event,'m-shaft')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body" style="padding-top:32px">
    ...
    <p class="pmodal-sub">Root-cause investigation of premature shaft failure in service. Identified rotational bending fatigue at a stress-concentrating shoulder, exacerbated by improper induction hardening sequence.</p>
    <div class="pmodal-tags"><span class="tag">Root Cause Analysis</span><span class="tag">Fatigue</span><span class="tag">FEA</span><span class="tag">Heat Treatment</span><span class="tag">S45C</span></div>
    <div class="pmdiv"></div>
    <div class="pm-fail-grid">
      <div class="pm-fail-cell"><p class="pm-fail-label">Failure Mode</p><p class="pm-fail-val">Rotational bending fatigue initiating at shaft shoulder (Ø53.5 → Ø52.5 mm). Classic beach marks on fracture surface confirm progressive fatigue.</p></div>
      <div class="pm-fail-cell"><p class="pm-fail-label">Material Condition</p><p class="pm-fail-val">S45C steel — coarse grain structure, Widmanstätten microstructure indicating overheating (~880°C induction) and improper heat treatment.</p></div>
      <div class="pm-fail-cell"><p class="pm-fail-label">Root Cause</p><p class="pm-fail-val">Stress concentration at fillet (R0.1) · Shallow hardened layer · Semi-finish machining removed the treated surface at the critical location.</p></div>
      <div class="pm-fail-cell"><p class="pm-fail-label">Process Sequence Error</p><p class="pm-fail-val">Heat treatment applied before final machining — negating the hardened surface layer at the highest-stress cross-section.</p></div>
    </div>
    <div class="pm-callout" style="margin-top:22px">
      <p class="pm-callout-title">Corrective Recommendations</p>
      <ul>
        <li>Increase fillet radius at shoulder transition from R0.1 to R ≥ 0.5 mm</li>
        <li>Audit induction hardening parameters — reduce peak temperature to suppress grain coarsening</li>
        <li>Revise sequence: Rough machine → Heat treat → Semi-finish machine (preserve hardened layer)</li>
...
<!-- BLDC -->
<div class="pmodal-ov" id="m-bldc" onclick="closeOut(event,'m-bldc')">
<div class="pmodal-box">
  <div class="pmodal-close-row"><button class="pmodal-x" onclick="closeM('m-bldc')">✕</button></div>
  <div class="pmodal-hero" style="cursor:zoom-in" onclick="lbOpen(['/images/bldc_ubc_torque.png','/images/bldc_ubc_compare result vsi.png'],0)">
    <div class="pmodal-hero-split" style="cursor:zoom-in">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">Dynamic MATLAB/Simulink simulation of a BLDC motor drive using Average Value Models, with a Maximum Torque Per Voltage control strategy derived by mathematically formulating the optimal voltage lead angle.</p>
    ...
    <div class="pm-grid">
      <div class="pm-field"><p class="pm-label">Method</p><div class="pm-val"><ul>
        ...
        <li>MTPV strategy from voltage constraint boundary</li>
        <li>Optimal voltage lead angle derived analytically</li>
      </ul></div></div>
      <div class="pm-field"><p class="pm-label">Results</p><div class="pm-val"><ul>
        <li>Maximized high-speed torque under voltage limits</li>
        <li>Reduced simulation compute time via AVM</li>
        <li>Control theory validated against full model</li>
      </ul></div></div>
    </div>
...
<!-- HVAC -->
<div class="pmodal-ov" id="m-hvac" onclick="closeOut(event,'m-hvac')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">GUI-based autonomous HVAC automation designed during internship — dynamic component monitoring, real-time closed-loop control, and energy consumption optimization.</p>
    ...
    <div class="pm-grid">
      ...
      <div class="pm-field"><p class="pm-label">Outcome</p><p class="pm-val">Autonomous system maintaining comfort setpoints while minimizing energy consumption across HVAC zones.</p></div>
    </div>
...
<!-- L-DED -->
<div class="pmodal-ov" id="m-lded" onclick="closeOut(event,'m-lded')">
<div class="pmodal-box">
  <div class="pmodal-close-row"><button class="pmodal-x" onclick="closeM('m-lded')">✕</button></div>
  <div class="pmodal-hero" onclick="lbOpen(['/images/additivie set up.jpeg'],0)">
    <img src="/images/additivie set up.jpeg" alt="L-DED setup" style="max-height:360px;object-fit:cover">
    <span class="pmodal-zoom-hint">Click to enlarge</span>
  </div>
  <div class="pmodal-body">
    <p class="pmodal-ey">Research · UBC Graduate Thesis</p>
    <h2 class="pmodal-title">L-DED Closed-Loop Temperature Monitoring</h2>
    <p class="pmodal-sub">Graduate thesis investigating closed-loop thermal control for Laser-based Directed Energy Deposition — real-time melt pool stabilization to reduce thermal defects.</p>
    ...
    <div class="pm-grid">
      ...
      <div class="pm-field"><p class="pm-label">Contribution</p><div class="pm-val"><ul>
        ...
        <li>Validated on L-DED experimental setup</li>
      </ul></div></div>
    </div>
    <a href="https://zhaolinwei-clark.github.io/mypaper/thesis/UBC_Thesis_ZhaolinWei_8928347__improved.pdf" class="pm-link" target="_blank">Read Thesis ↗</a>
  </div>
</div></div>

<!-- SENSOR -->
<div class="pmodal-ov" id="m-sensor" onclick="closeOut(event,'m-sensor')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">Novel self-powered flexible sensors detecting pulse and muscle signals for personal health monitoring — full pipeline from material synthesis through device integration.</p>
    ...
    <div class="pm-grid">
      ...
      <div class="pm-field"><p class="pm-label">Pipeline</p><p class="pm-val">Material synthesis → electromechanical characterization → signal detection validation → wearable integration</p></div>
    </div>
...
<!-- CHATTER -->
<div class="pmodal-ov" id="m-chatter" onclick="closeOut(event,'m-chatter')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body" style="padding-top:32px">
    ...
    <p class="pmodal-sub">Chatter stability prediction and machining optimization for aluminum alloy slot milling — FRF modeling, stability lobe diagram generation, and feed drive control design.</p>
    ...
    <div class="pmdiv"></div>
    <div class="pm-grid">
      <div class="pm-field"><p class="pm-label">Analysis</p><div class="pm-val"><ul>
        ...
        <li>Optimal spindle speed selection</li>
      </ul></div></div>
      <div class="pm-field"><p class="pm-label">Control Design</p><div class="pm-val"><ul>
        <li>Lead-lag compensator for feed drive system</li>
...
<!-- ALOHA -->
<div class="pmodal-ov" id="m-aloha" onclick="closeOut(event,'m-aloha')">
<div class="pmodal-box">
  ...
  <div class="pmodal-hero" onclick="lbOpen(['/images/Image_robot_in_progress1.png'],0)">
    <img src="/images/Image_robot_in_progress1.png" alt="AlohaMini" style="max-height:380px;object-fit:cover">
    <span class="pmodal-zoom-hint">Click to enlarge</span>
  </div>
  <div class="pmodal-body">
    <p class="pmodal-ey">Robotics · In Progress</p>
    <h2 class="pmodal-title">Low-Cost Dual-Arm Mobile Robot — AlohaMini</h2>
    <p class="pmodal-sub">Building a low-cost teleoperated dual-arm mobile manipulator on the open-source AlohaMini framework to validate imitation learning algorithms on household manipulation tasks.</p>
    ...
    <div class="pm-grid">
      ...
      <div class="pm-field"><p class="pm-label">Goal</p><p class="pm-val">Validate imitation learning on household manipulation tasks using ACT/Diffusion Policy benchmarks on a reproducible low-cost platform.</p></div>
    </div>
  </div>
</div></div>

<!-- SURGICAL -->
<div class="pmodal-ov" id="m-surgical" onclick="closeOut(event,'m-surgical')">
<div class="pmodal-box">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">Real-time stereo vision tracking of surgical instruments and soft tissue. Lucas-Kanade optical flow with Shi-Tomasi detection — sub-pixel accuracy and reduced failure rate.</p>
    <div class="pmodal-tags"><span class="tag">Python</span><span class="tag">OpenCV</span><span class="tag">Robotics</span><span class="tag">Computer Vision</span></div>
    <div class="pmdiv"></div>
    <div class="pm-grid">
      <div class="pm-field"><p class="pm-label">Method</p><div class="pm-val"><ul>
      ...
      <div class="pm-field"><p class="pm-label">Results</p><div class="pm-val"><ul>
        ...
        <li>Real-time performance on standard hardware</li>
      </ul></div></div>
    </div>
  </div>
</div></div>
...
<!-- HEATER -->
<div class="pmodal-ov" id="m-heater" onclick="closeOut(event,'m-heater')">
<div class="pmodal-box">
  <div class="pmodal-close-row"><button class="pmodal-x" onclick="closeM('m-heater')">✕</button></div>
  <div class="pmodal-hero" style="cursor:zoom-in" onclick="lbOpen(['/images/Poster Assembly Picture.PNG','/images/Poster Explorsion Veiw.PNG'],0)">
  ...
  <div class="pmodal-body">
    ...
    <p class="pmodal-sub">Arduino closed-loop cup heater with user-selectable 10–80°C setpoint, calibrated NTC sensor, and real-time LCD feedback.</p>
    ...
    <div class="pm-grid">
      <div class="pm-field"><p class="pm-label">Hardware</p><div class="pm-val"><ul>
        <li>Arduino microcontroller</li><li>NTC thermistor — calibrated vs reference</li>
        <li>LCD display — real-time readout</li><li>Button interface — setpoint adjustment</li>
      </ul></div></div>
      <div class="pm-field"><p class="pm-label">Key Work</p><div class="pm-val"><ul>
...
<!-- EM TOOL -->
<div class="pmodal-ov" id="m-em" onclick="closeOut(event,'m-em')">
<div class="pmodal-box">
  <div class="pmodal-close-row"><button class="pmodal-x" onclick="closeM('m-em')">✕</button></div>
  <div class="pmodal-body" style="padding-top:32px">
    <p class="pmodal-ey">Embedded Systems · Independent Project</p>
    <h2 class="pmodal-title">Electromagnetic Calculation Tool — DC PM Motors</h2>
    <p class="pmodal-sub">Python tool automating magnetic circuit analysis for DC permanent magnet motors — eliminates manual iteration in preliminary design.</p>
    <div class="pmodal-tags"><span class="tag">Python</span><span class="tag">Motor</span><span class="tag">Control</span></div>
    <div class="pmdiv"></div>
    <div class="pm-grid">
      <div class="pm-field"><p class="pm-label">Function</p><div class="pm-val"><ul>
        ...
        <li>Performance curve output for rapid comparison</li>
      </ul></div></div>
      <div class="pm-field"><p class="pm-label">Impact</p><div class="pm-val"><ul>
        <li>Eliminates manual iteration in preliminary design</li>
...
<!-- LIGHTBOX -->
<div class="lb-ov" id="lightbox" onclick="lbClose()">
...
document.getElementById('lightbox').addEventListener('click',function(e){if(e.target===this||e.target===document.querySelector('.lb-close'))lbClose()});
...
document.querySelectorAll('.ftag').forEach(function(t){
  t.addEventListener('click',function(){
    ...
    /* Auto-expand sections with visible cards */
    document.querySelectorAll('.cat').forEach(function(sec){
      ...
      if(vis&&sec.classList.contains('closed')){
        sec.classList.remove('closed');body.style.maxHeight='none';
      }
    });
  });
});
